...
const LandingPage = () => {
  ...
  return (
    <div>
      ...
      <div className="my-16 space-y-6 discover full-bleed py-6">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-800 text-justify sm:text-center">
            ...
            engaging <b className="text-indigo-600">blogs</b>, Lighten up your day with our quick-witted{" "}
            <b className="text-indigo-600">jokes</b>
            collection, Inspiration awaits! Explore our curated <b className="text-indigo-600">
              quotes
            </b>{" "}
        ...
        <div className="py-6">
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
            {primaryFeatures.map((feature) => (
              <div
                key={feature.name}
                className="flex flex-col shadow-sm border rounded-md p-3 bg-white"
              >
